...
static void imap_match_it__many(void **state) {
	...
	const struct IMapIt *it = imap_match_it(map, mock_3pred_szt_ptr, D0);
	assert_non_nul(it);
	assert_int_equal(it->key, 1);
...
static void imap_match_key_it__many(void **state) {
	...
	const struct IMapIt *it = imap_match_key_it(map, mock_2pred_szt, D0);
	assert_non_nul(it);
	assert_int_equal(it->key, 1);
	assert_ptr_equal(it->val, V1);
...
static void imap_match_val_it__many(void **state) {
	...
	const struct IMapIt *it = imap_match_val_it(map, mock_2pred, D0);
	assert_non_nul(it);
	assert_int_equal(it->key, 1);
	assert_ptr_equal(it->val, V1);
...
static void imap_match_it__none(void **state) {
	...
	assert_nul(imap_match_it(map, mock_3pred_szt_ptr, D0));
...
static void imap_match_it_key__none(void **state) {
	...
	assert_nul(imap_match_key_it(map, mock_2pred_szt, D0));
...
static void imap_match_it_val__none(void **state) {
	...
	assert_nul(imap_match_val_it(map, mock_2pred, D0));
...
static void imap_match__matches(void **state) {
	...
	const struct IMapPair v_pair = imap_match(map, mock_3pred_szt_ptr, D0);
...
static void imap_match_key__matches(void **state) {
	...
	const struct IMapPair k_pair = imap_match_key(map, mock_2pred_szt, D0);
...
static void imap_match_val__matches(void **state) {
	...
	const struct IMapPair kv_pair = imap_match_val(map, mock_2pred, D0);
...
static void imap_match__no_match(void **state) {
	...
	const struct IMapPair kv_pair = imap_match(map, mock_3pred_szt_ptr, D0);
...
static void imap_match_val__no_match(void **state) {
	...
	const struct IMapPair v_pair = imap_match_val(map, mock_2pred, D0);
...
static void imap_put_all__variants(void **state) {
	...
	// put_all
	const struct IMap *actual = imap_clone(to);
...
static void imap_vals_pset_clone__many(void **state) {
...
static void imap_clone__many(void **state) {
	const struct IMapParams params = { .allow_null_val = true, };
	...
	const struct IMap *to = imap_clone(from);
...
static void imap_clone__params(void **state) {
	const struct IMapParams params = {
...
int main(void) {
	const struct CMUnitTest tests[] = {
		...
		TEST(imap_clone__many),
		TEST(imap_clone__params),
