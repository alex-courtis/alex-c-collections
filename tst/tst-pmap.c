...
static void pmap_clone_deep__alloc_val(void **state) {
...
static void pmap_clone_deep__no_alloc_val(void **state) {
	const struct PMap *from = pmap_init();
...
static void pmap_put__alloc_val(void **state) {
	const struct PMapParams params = { .alloc_val = mock_alloc, };
	const struct PMap *tab = pmap_init_with(params);
...
static void pmap_keys_slist_deep__alloc_key(void **state) {
	const struct PMapParams params = { .alloc_key = mock_alloc, };
	const struct PMap *tab = pmap_init_with(params);
...
static void pmap_vals_slist_deep__alloc_val(void **state) {
	const struct PMapParams params = { .alloc_val = mock_alloc, };
	const struct PMap *tab = pmap_init_with(params);
...
static void pmap_vals_slist_deep__no_alloc_val(void **state) {
	const struct PMap *tab = pmap_init();
...
int main(void) {
	const struct CMUnitTest tests[] = {
		...
		TEST(pmap_clone_deep__alloc_val),
		TEST(pmap_clone_deep__no_alloc_val),
		...
		TEST(pmap_keys_slist_deep__alloc_key),
		TEST(pmap_keys_slist_deep__no_alloc_key),

		TEST(pmap_vals_slist_shallow__empty),
		TEST(pmap_vals_slist_shallow__many),

		TEST(pmap_vals_slist_deep__alloc_val),
		TEST(pmap_vals_slist_deep__no_alloc_val),
