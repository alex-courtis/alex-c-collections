...
static void slist_remove_all__some(void **state) {
	...
	slist_remove_all(&list, (fn_2pred)equal_strcmp, "x");
...
static void slist_remove_all_free__some(void **state) {
	...
	slist_remove_all_free(&list, (fn_2pred)equal_strcmp, "x", mock_free);
...
static void slist_find_equal_val__no(void **state) {
	...
	const void *val = slist_find_equal_val(list, (fn_2pred)equal_strcmp, "x");
	assert_nul(val);

	const struct SList *i = slist_find_equal(list, (fn_2pred)equal_strcmp, "x");
	assert_nul(i);
...
static void slist_find_equal_val__yes(void **state) {
	...
	const void *val = slist_find_equal_val(list, (fn_2pred)equal_strcmp, "1");
	assert_non_nul(val);
	assert_str_equal(val, "1");

	const struct SList *i = slist_find_equal(list, (fn_2pred)equal_strcmp, "1");
	assert_non_nul(i);
	assert_str_equal(i->val, "1");
...
static void slist_equal__empty_lhs(void **state) {
	...
	assert_slist_not_equal(NULL, rhs, (fn_2pred)equal_strcmp, NULL);
...
static void slist_equal__empty_rhs(void **state) {
	...
	assert_slist_not_equal(lhs, NULL, (fn_2pred)equal_strcmp, NULL);
...
static void slist_equal__equal(void **state) {
	...
	assert_slist_equal(lhs, rhs, (fn_2pred)equal_strcmp, NULL);
...
static void slist_equal__not_equal_start(void **state) {
	...
	assert_slist_not_equal(lhs, rhs, (fn_2pred)equal_strcmp, NULL);
...
static void slist_sort__words(void **state) {
	...
	struct SList *actual = slist_sort(from, (fn_2pred)less_than_strcmp);
	...
	assert_slist_equal(actual, expected, (fn_2pred)equal_strcmp, NULL);
...
static void slist_move__empty(void **state) {
	...
	slist_move(&to, &from, (fn_2pred)equal_strcmp, "x");
	assert_nul(to);

	slist_move(&to, NULL, (fn_2pred)equal_strcmp, "x");
	assert_nul(to);
...
static void slist_move__many(void **state) {
	...
	slist_move(&to, &from, (fn_2pred)equal_strstr, "x");
...
static void slist_xor_free__empty_lists(void **state) {
	...
	slist_xor_free(&list1, list2, (fn_2pred)equal_strcmp, NULL, (fn_clone)clone_strdup);
...
static void slist_xor_free__first_list_empty(void **state) {
	...
	assert_slist_equal(list1, expected, (fn_2pred)equal_strcmp, NULL);
...
static void slist_xor_free__vals(void **state) {
	...
	slist_xor_free(&list1, list2, (fn_2pred)equal_strcmp, NULL, NULL);
